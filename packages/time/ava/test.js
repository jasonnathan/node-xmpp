...
test('time', t => {
  ...
  t.is(time.time(d), '02:56:00.000Z')
  t.is(time.time(s), '02:56:00.000Z')
})

test('datime', t => {
  t.is(time.datetime(), time.datetime(new Date()))
  t.is(time.datetime(d), '1969-07-21T02:56:00.000Z')
  t.is(time.datetime(s), '1969-07-21T02:56:00.000Z')
})
